        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row gap-x-16">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ date_format($fundraisingWithdrawal->created_at, 'd M Y') }}</h3>
                        </div>
                    </div>
                    <div>
                ...
                @if ($fundraisingWithdrawal->has_sent)
                    ...
                    @else
                    <h3 class="text-indigo-950 text-xl font-bold mb-5">Dana Sudah Diberikan</h3>
                    @forelse ($fundraisingWithdrawal->fundraising->fundraisingPhases as $fundraisingPhase)
                    <img src="{{ Storage::url($fundraisingPhase->photo) }}" alt="" class="rounded-2xl object-cover w-[300px] h-[200px] mb-3">
                    @empty
