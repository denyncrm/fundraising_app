            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <div class="flex flex-row justify-between">
                    ...
                    <span class="text-white font-bold bg-green-500 rounded-2xl w-full p-5">
                        Fundraising Sudah Disetujui oleh Admin
                    </span>
                    @else
                    ...
                    @role('owner')
                    <form action="{{ route('admin.fundraisings.activate_fundraising', $fundraising) }}" method="POST">
                        @csrf
                ...
                <form method="POST" action="{{ route('admin.fundraising_witdrawals.store', $fundraising) }}" enctype="multipart/form-data">
                    @csrf
                ...
                @else
                <p>Permintaan Withdrawal Sedang diproses</p>
                @endif
                @endif
